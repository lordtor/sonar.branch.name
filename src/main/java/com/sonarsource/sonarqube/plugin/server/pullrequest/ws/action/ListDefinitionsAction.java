 ...
 *
 */
package com.sonarsource.sonarqube.plugin.server.pullrequest.ws.action;
...
public class ListDefinitionsAction extends AlmSettingsWsAction {
    ...
    ListDefinitionsAction(DbClient dbClient, UserSession userSession, ProtoBufWriter protoBufWriter) {
        super(dbClient);
