...
import com.sonarsource.sonarqube.plugin.server.pullrequest.ws.action.CreateAction;
...
public class CreateBitbucketAction extends CreateAction {
    ...
    public CreateBitbucketAction(DbClient dbClient, UserSession userSession) {
        super(dbClient, userSession, "create_bitbucket");
    }
