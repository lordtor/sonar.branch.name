 ...
 *
 */
package com.sonarsource.sonarqube.plugin.server.pullrequest.ws.action.bitbucket;

import com.sonarsource.sonarqube.plugin.server.pullrequest.ws.action.UpdateAction;
...
public class UpdateBitbucketAction extends UpdateAction {
    ...
    public UpdateBitbucketAction(DbClient dbClient, UserSession userSession) {
        super(dbClient, userSession, "update_bitbucket");
    }
