package com.sonarsource.sonarqube.plugin.ce.pullrequest.bitbucket.client;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.databind.ObjectReader;
import com.sonarsource.sonarqube.plugin.ce.pullrequest.bitbucket.client.model.AnnotationUploadLimit;
import com.sonarsource.sonarqube.plugin.ce.pullrequest.bitbucket.client.model.BitbucketConfiguration;
import com.sonarsource.sonarqube.plugin.ce.pullrequest.bitbucket.client.model.CodeInsightsAnnotation;
import com.sonarsource.sonarqube.plugin.ce.pullrequest.bitbucket.client.model.CodeInsightsReport;
import com.sonarsource.sonarqube.plugin.ce.pullrequest.bitbucket.client.model.DataValue;
import com.sonarsource.sonarqube.plugin.ce.pullrequest.bitbucket.client.model.server.Annotation;
import com.sonarsource.sonarqube.plugin.ce.pullrequest.bitbucket.client.model.server.CreateReportRequest;
import com.sonarsource.sonarqube.plugin.ce.pullrequest.bitbucket.client.model.server.ErrorResponse;
import com.sonarsource.sonarqube.plugin.ce.pullrequest.bitbucket.client.model.server.ServerProperties;
...
public class BitbucketServerClientUnitTest {
    ...
    public void testUploadReport() throws IOException {
        ...
        assertEquals("https://my-server.org/rest/insights/1.0/projects/project/repos/repository/commits/commit/reports/com.sonarsource.sonarqube", request.url().toString());
    }
    ...
    public void testUploadAnnotations() throws IOException {
        ...
        assertEquals("https://my-server.org/rest/insights/1.0/projects/project/repos/repository/commits/commit/reports/com.sonarsource.sonarqube/annotations", request.url().toString());
    }
