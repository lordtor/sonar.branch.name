...
import com.sonarsource.sonarqube.plugin.ce.pullrequest.bitbucket.client.model.cloud.CloudAnnotation;
import com.sonarsource.sonarqube.plugin.ce.pullrequest.bitbucket.client.model.cloud.CloudCreateReportRequest;
...
public class BitbucketCloudClientUnitTest {
    ...
    public void testUploadReport() throws IOException {
        ...
        assertEquals("https://api.bitbucket.org/2.0/repositories/project/repository/commit/commit/reports/com.sonarsource.sonarqube", request.url().toString());
    }
    ...
    public void testUploadAnnotations() throws IOException {
        ...
        assertEquals("https://api.bitbucket.org/2.0/repositories/project/repository/commit/commit/reports/com.sonarsource.sonarqube/annotations", request.url().toString());
    }
